...
def test_calculate_balance():
    ...
    blockchain.add_block([Transaction.to_json(transaction)])
    ...
    blockchain.add_block(
        [Transaction.to_json(received_transaction_1),
         Transaction.to_json(received_transaction_2)]
    )
