...
def test_mined_block_difficulty_limits_1():
    last_block = Block(
        time.time_ns(),
        'test_last_hash',
        'test_hash',
...
#fixture decorator defines block and last_block for repetitive calls
@pytest.fixture
def last_block():
...
def test_is_valid_block_bad_block_hash(last_block, block):
    block.hash = '00000000000000000bbabc'
