...
class Wallet:
    ...
    Keeps track od the miner's balance.
    ...
    def calculate_balance(blockchain, address):
        """
        Calculate the balance of he given address considering the transaction
        data within the blockchain

        The balance is found by adding the output values that belong to the 
        addtess since the most recent transaction by that address.
        """
